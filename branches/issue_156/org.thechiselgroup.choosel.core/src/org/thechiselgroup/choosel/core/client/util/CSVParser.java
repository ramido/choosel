 ...
 */
/*
 * CHANGES MADE IN CHOOSEL:
 * 
 * (1)Changed isAllWhiteSpace method to use regular expressions instead of
 * Character.isWhitespace, because this method is not available in GWT (Lars
 * Grammel)
 */
public class CSVParser {
    ...
    protected boolean isAllWhiteSpace(CharSequence sb) {
        ...
        for (int i = 0; i < sb.length(); i++) {
            /*
             * CHANGED IN CHOOSEL Whitespace check -- Character.isWhitespace is
