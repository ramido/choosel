...
public class Dot extends Mark {
    ...
    public final native Dot angle(DoubleFunction<?> f) /*-{
    ...
    public final native Dot bottom(DoubleFunction<?> f) /*-{
    ...
    public final native Dot bottom(DoubleFunctionDoubleArg f) /*-{
        return this.bottom(@org.thechiselgroup.choosel.protovis.client.Mark::toJavaScriptFunction(Lcom/google/gwt/core/client/JavaScriptObject;Lorg/thechiselgroup/choosel/protovis/client/DoubleFunctionDoubleArg;)(this,f));
    }-*/;
    ...
    public final native Dot def(String name, DoubleFunction<?> f) /*-{
    ...
    public final native Dot fillStyle(StringFunction<?> f) /*-{
    ...
    public final native Dot left(DoubleFunction<?> f) /*-{
    ...
    public final native Dot left(DoubleFunctionDoubleArg f) /*-{
        return this.left(@org.thechiselgroup.choosel.protovis.client.Mark::toJavaScriptFunction(Lcom/google/gwt/core/client/JavaScriptObject;Lorg/thechiselgroup/choosel/protovis/client/DoubleFunctionDoubleArg;)(this,f));
    }-*/;
    ...
    public final native Dot radius(DoubleFunctionDoubleArg f) /*-{
        return this.radius(@org.thechiselgroup.choosel.protovis.client.Mark::toJavaScriptFunction(Lcom/google/gwt/core/client/JavaScriptObject;Lorg/thechiselgroup/choosel/protovis/client/DoubleFunctionDoubleArg;)(this,f));
    }-*/;
    ...
    public final native Dot right(DoubleFunction<?> f) /*-{
    ...
    public final native Dot right(DoubleFunctionDoubleArg f) /*-{
        return this.right(@org.thechiselgroup.choosel.protovis.client.Mark::toJavaScriptFunction(Lcom/google/gwt/core/client/JavaScriptObject;Lorg/thechiselgroup/choosel/protovis/client/DoubleFunctionDoubleArg;)(this,f));
    }-*/;
    ...
    public final native Dot size(DoubleFunctionDoubleArg f) /*-{
        return this.size(@org.thechiselgroup.choosel.protovis.client.Mark::toJavaScriptFunction(Lcom/google/gwt/core/client/JavaScriptObject;Lorg/thechiselgroup/choosel/protovis/client/DoubleFunctionDoubleArg;)(this,f));
    }-*/;
    ...
    public final native Dot top(DoubleFunction<?> f) /*-{
