 ...
 *******************************************************************************/
package org.thechiselgroup.choosel.workbench.client.util.url;
...
public class FlashUrlFetchService extends SWFWidget implements UrlFetchService {
    ...
    private static native void exportStaticMethods() /*-{
        ...
        @org.thechiselgroup.choosel.workbench.client.util.url.FlashUrlFetchService::_onLoad(Ljava/lang/String;));
        $wnd._flexproxy_callback=$entry(
        @org.thechiselgroup.choosel.workbench.client.util.url.FlashUrlFetchService::_callback(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;));
    }-*/;
    // @formatter:on
