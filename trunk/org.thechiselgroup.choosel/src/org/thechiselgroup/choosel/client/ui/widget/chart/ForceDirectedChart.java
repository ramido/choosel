...
public class ForceDirectedChart extends ChartWidget {
	...
	var colors = $wnd.pv.Colors.category19();
	
	var vis = new $wnd.pv.Panel()
	    .width(width)
	    .height(height)
	    .fillStyle("white")
	    .event("mousedown", $wnd.pv.Behavior.pan())
	    .event("mousewheel", $wnd.pv.Behavior.zoom());
	
	var force = vis.add($wnd.pv.Layout.Force)
	    .nodes(miserables.nodes)
	    .links(miserables.links);
	
	force.link.add($wnd.pv.Line);
	
	force.node.add($wnd.pv.Dot)
