...
public class TimeChart extends ChartWidget {
    ...
    public native void drawChart() /*-{
        ...
        this.@org.thechiselgroup.choosel.client.ui.widget.chart.TimeChart::sortByDate()();

        for(var i = 0; i < this.@org.thechiselgroup.choosel.client.ui.widget.chart.ChartWidget::chartItems.@java.util.ArrayList::size()(); i++) {
        ...
        var w = this.@org.thechiselgroup.choosel.client.ui.widget.chart.ChartWidget::width - 25,
            h1 = this.@org.thechiselgroup.choosel.client.ui.widget.chart.ChartWidget::height - 60,
            h2 = 30,
