...
public class NCBOMappingNeighbourhoodServiceAsyncClientImplementation extends
	...
	private Resource parseMapping(Object node) {
		...
		mapping.putValue(MAPPING_SOURCE,
				NcboUriHelper.toConceptURI(sourceOntologyId, sourceConceptId));
		...
		mapping.putValue(MAPPING_DESTINATION_ONTOLOGY_ID, destinationOntologyId);
