...
public class JsTimeLine extends JavaScriptObject {
    ...
    public static native JsTimeLine create(Element element,
        ...
        zoomIndex: 7,
        zoomSteps: new Array(
        {pixelsPerInterval: 280, unit: $wnd.SimileAjax.DateTime.HOUR},
        {pixelsPerInterval: 140, unit: $wnd.SimileAjax.DateTime.HOUR},
        {pixelsPerInterval: 70, unit: $wnd.SimileAjax.DateTime.HOUR},
        {pixelsPerInterval: 35, unit: $wnd.SimileAjax.DateTime.HOUR},
        {pixelsPerInterval: 400, unit: $wnd.SimileAjax.DateTime.DAY},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.DAY},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.DAY},
        {pixelsPerInterval: 50, unit: $wnd.SimileAjax.DateTime.DAY},
        {pixelsPerInterval: 400, unit: $wnd.SimileAjax.DateTime.MONTH},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.MONTH},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.MONTH},
        {pixelsPerInterval: 400, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 50, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 400, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 50, unit: $wnd.SimileAjax.DateTime.DECADE})
        }),         
        $wnd.Timeline.createBandInfo({
        startsOn: dateAsString,
        ...
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 40, unit: $wnd.SimileAjax.DateTime.YEAR},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 40, unit: $wnd.SimileAjax.DateTime.DECADE},
        {pixelsPerInterval: 200, unit: $wnd.SimileAjax.DateTime.CENTURY},
        {pixelsPerInterval: 100, unit: $wnd.SimileAjax.DateTime.CENTURY})
        })
        ];
