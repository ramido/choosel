...
@GinModules(ComponentExampleClientModule.class)
public interface ComponentExampleGinjector extends Ginjector {

    WindowContentProducer getWindowContentProducer();
