...
public class TimeChartViewContentDisplay extends ChartViewContentDisplay {
    ...
    public native void buildChart() /*-{
        ...
        var w = this.@org.thechiselgroup.choosel.visualization_component.chart.client.ChartViewContentDisplay::width - 25,
            h1 = this.@org.thechiselgroup.choosel.visualization_component.chart.client.ChartViewContentDisplay::height - 60,
            h2 = 30,
