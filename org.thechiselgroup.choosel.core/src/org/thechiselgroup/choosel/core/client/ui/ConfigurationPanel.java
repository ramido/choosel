...
public class ConfigurationPanel extends VerticalPanel {
    ...
    public void addConfigurationSetting(String name, Widget widget) {
        assert name != null;
        assert widget != null;

        FlowPanel settingPanel = new FlowPanel();
        settingPanel.setStyleName(CSS_CONFIGURATION_PANEL_SETTING);
